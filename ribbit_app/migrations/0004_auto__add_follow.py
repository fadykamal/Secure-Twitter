...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Follow'
        db.create_table('ribbit_app_follow', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('follower', self.gf('django.db.models.fields.related.ForeignKey')(related_name='follower', to=orm['ribbit_app.UserProfile'])),
            ('followed', self.gf('django.db.models.fields.related.ForeignKey')(related_name='followed', to=orm['ribbit_app.UserProfile'])),
        ))
        db.send_create_signal('ribbit_app', ['Follow'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('ribbit_app_follow')
    ...
    models = {
        ...
        'ribbit_app.follow': {
            ...
            'followed': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'followed'", 'to': "orm['ribbit_app.UserProfile']"}),
            'follower': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'follower'", 'to': "orm['ribbit_app.UserProfile']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'ribbit_app.messages': {
