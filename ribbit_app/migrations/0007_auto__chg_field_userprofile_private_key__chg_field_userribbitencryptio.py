...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.private_key'
        db.alter_column(u'ribbit_app_userprofile', 'private_key', self.gf('django.db.models.fields.CharField')(max_length=1024))

        # Changing field 'UserRibbitEncryption.public_key'
        db.alter_column(u'ribbit_app_userribbitencryption', 'public_key', self.gf('django.db.models.fields.CharField')(max_length=1024))

    def backwards(self, orm):

        # Changing field 'UserProfile.private_key'
        db.alter_column(u'ribbit_app_userprofile', 'private_key', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'UserRibbitEncryption.public_key'
        db.alter_column(u'ribbit_app_userribbitencryption', 'public_key', self.gf('django.db.models.fields.CharField')(max_length=100))
