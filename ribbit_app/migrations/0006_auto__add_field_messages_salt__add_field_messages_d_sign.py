...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Messages.salt'
        db.add_column(u'ribbit_app_messages', 'salt',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'Messages.d_sign'
        db.add_column(u'ribbit_app_messages', 'd_sign',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=128),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Messages.salt'
        db.delete_column(u'ribbit_app_messages', 'salt')

        # Deleting field 'Messages.d_sign'
        db.delete_column(u'ribbit_app_messages', 'd_sign')
