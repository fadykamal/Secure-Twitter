...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'RibbitForFollowers'
        db.create_table(u'ribbit_app_ribbitforfollowers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('public_key', self.gf('django.db.models.fields.CharField')(max_length=140)),
            ('encrypted_content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('d_sign', self.gf('django.db.models.fields.CharField')(default='', max_length=128)),
        ))
        db.send_create_signal(u'ribbit_app', ['RibbitForFollowers'])

        # Adding field 'Ribbit.retweeted'
        db.add_column(u'ribbit_app_ribbit', 'retweeted',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'RibbitForFollowers'
        db.delete_table(u'ribbit_app_ribbitforfollowers')

        # Deleting field 'Ribbit.retweeted'
        db.delete_column(u'ribbit_app_ribbit', 'retweeted')
