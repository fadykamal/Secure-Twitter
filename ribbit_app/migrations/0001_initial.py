...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ribbit_app_userribbitencryption', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
            ('private_key', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal(u'ribbit_app', ['UserRibbitEncryption'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'ribbit_app_userribbitencryption')
