...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FollowRequest.answered'
        db.add_column(u'ribbit_app_followrequest', 'answered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FollowRequest.answered'
        db.delete_column(u'ribbit_app_followrequest', 'answered')
